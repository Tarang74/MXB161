...
\begin{table}[H]
    ...
    \begin{tabular}{c c c}
        ...
        \lstinline!uint8!   & unsigned 8-bit integers           & \lstinline!0 ... 2^8!            \\ % chktex 11 % chktex 26
        \lstinline!int8!    & unsigned 8-bit integers           & \lstinline!-2^8 ... 2^8!         \\ % chktex 11 % chktex 26
        \lstinline!single!  & single precision ``real'' numbers & \lstinline!-realmax ... realmax! \\ % chktex 11 % chktex 26 % chktex 12
        \lstinline!double!  & double precision ``real'' numbers & \lstinline!-realmax ... realmax! \\ % chktex 11 % chktex 26 % chktex 12
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{multicols}{2}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{c c}
            ...
            \textbf{Symbol} & \textbf{Role}           \\
            \midrule
            \lstinline!&!   & logical \lstinline!AND! \\ % % chktex 13
            \lstinline!|!   & logical \lstinline!OR!  \\ % % chktex 13
            \lstinline!~!   & logical \lstinline!NOT! \\ % % chktex 13
            \bottomrule
        \end{tabular}
    \end{table}
\end{multicols}
...
\begin{table}[H]
    ...
    \begin{tabular}{c c}
        ...
        \lstinline!( )! & Operator precedence                                                \\ % chktex 37
        \lstinline![ ]! & Array creation, multiple output argument assignment                \\
        \lstinline!%!   & Comment                                                            \\
        \lstinline!""!  & String constructor                                                 \\ % chktex 37 chktex 18
